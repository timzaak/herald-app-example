> A Flutter app (Dart) using Riverpod for state management, Dio for networking, go_router for navigation, and a Material-based UI. Includes i18n, FCM push notifications, Google Analytics, and an integration/patrol test setup.
